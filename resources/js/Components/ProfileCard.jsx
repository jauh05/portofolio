...
const ProfileCardComponent = ({
    ...
    const cardStyle = useMemo(
        () => ({
            ...
            '--behind-glow-color': behindGlowColor ?? 'rgba(var(--primary-rgb), 0.67)',
            ...
            '--card-opacity': '1', // Always visible
            '--rotate-x': '0deg',
            '--rotate-y': '0deg',
            '--background-x': '50%',
            '--background-y': '50%',
            '--card-radius': cardRadius,
            '--sunpillar-1': 'hsl(var(--primary-rgb), 100%, 73%)',
            '--sunpillar-2': 'hsl(53, 100%, 69%)',
            '--sunpillar-3': 'hsl(93, 100%, 69%)',
            '--sunpillar-4': 'hsl(176, 100%, 76%)',
            '--sunpillar-5': 'hsl(228, 100%, 74%)',
            '--sunpillar-6': 'hsl(283, 100%, 73%)',
            '--sunpillar-clr-1': 'linear-gradient(rgba(var(--primary-rgb), 0.5), rgba(var(--primary-rgb), 0.5))',
            ...
            <div ref={shellRef} className="relative z-[1] group">
                <section
                    ...
                    style={{
                        ...
                        boxShadow:
                            'rgba(0, 0, 0, 0.4) calc((var(--pointer-from-left) * 10px) - 5px) calc((var(--pointer-from-top) * 20px) - 10px) 30px -5px',
                ...
                >
                    ...
                    >
                        ...
                        {/* Avatar content */}
                        <div
                            className="overflow-hidden backface-hidden"
                            style={{
                        ...
                        >
                            <img
                                ...
                                style={{
                                    ...
                                    transform:
                                        'scale(1.1) translateX(calc((var(--pointer-from-left) - 0.5) * 10px)) translateY(calc((var(--pointer-from-top) - 0.5) * 10px))',
                                    borderRadius: cardRadius
                                }}
                            />
                            {showUserInfo && (
                                ...
                                >
                                    <div className="flex items-center gap-3 text-left">
                                        <div className="flex flex-col items-start gap-0.5">
                                            <div className="text-xs font-black text-white leading-none">@{handle}</div>
                                            <div className="text-[10px] text-white/70 leading-none">{status}</div>
                                        </div>
                                    </div>
                                    <a
                                        href="#contact"
                                        className="bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-[10px] font-black text-white hover:bg-white/20 transition-all"
                                    >
                                        {contactText}
                                    </a>
                                </div>
                        ...
                        <div
                            ...
                            style={{
                                transform:
                                    'translate3d(calc(var(--pointer-from-left) * -10px + 5px), calc(var(--pointer-from-top) * -10px + 5px), 0.1px)',
                                gridArea: '1 / -1',
                                borderRadius: cardRadius,
                                pointerEvents: 'none'
                            }}
                        >
                            <div className="w-full absolute flex flex-col items-center" style={{ top: '2em' }}>
                                <h3
                                    className="font-black m-0 tracking-tighter"
                                    style={{
                                        fontSize: '2.5rem',
                                        color: 'white',
                                ...
                                <p
                                    className="font-bold text-white/80 text-xs tracking-widest uppercase"
                                >
                                    {title}
                                </p>
                            </div>
