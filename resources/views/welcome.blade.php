...
<head>
    ...
    <title>Jauhar Fauzi Ulul Albab — AI Engineer & Software Developer</title>
    <meta name="description" content="Portfolio Jauhar Fauzi Ulul Albab — AI engineer, software developer, dan digital solutions builder dari Yogyakarta.">
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero h1 { font-size: clamp(6rem, 12vw, 11rem); font-weight: 800; margin: 0 0 18px; line-height: 0.95; letter-spacing: -.05em; color: var(--ink); }
